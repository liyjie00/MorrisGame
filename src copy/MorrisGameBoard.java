...
//    }
    ...
    public int staticMinEnd(char[] position, int depth, Boolean myTurn) {
//        System.out.println(String.valueOf(position));
        ...
        if (!myTurn) { // the next turn is not mine ( is black)
            char[] revPos = reverse(position);
            list = genMoveMidEnd(revPos);
        } else {
            list = genMoveMidEnd(position);
        }

        int numBlackMoves = list.size();
//        System.out.print(position);
//        System.out.print(" " + numBlackMoves);
        if (numBlackMoves == 0) {
//            System.out.println("in " + myNextTurn);
            if (myNextTurn) {
//                System.out.println("in in");
    ...
    public int staticMidEndImproved(char[] position, int depth, Boolean turn) {
        int staticMidEnd = staticMinEnd(position, depth, turn);
//        int num2PiecesConf = count2PiecesW(position);
//        int num3PiecesConf = 0;
//        if (num2PiecesConf >= 2) {
//            num3PiecesConf = num2PiecesConf - 1;
//        }
//        System.out.println(staticMidEnd);
//        System.out.println(depth);
        ...
        if (staticMidEnd == -10000){
//            System.out.println("out" + staticMidEnd);
            return  staticMidEnd;
        }
        int es = staticMidEnd + 100 * countMills(position) + 300 * doubleMills(position);
...
//        switch (loc) {
//            case 0:
//                return new int[][]{{1,2}, {9, 21}};
//            case 1:
//                return new int[][]{{0, 2}, {4, 8}};
//            case 2:
//                return new int[][]{{0, 1}, {14, 23}};
//            case 3:
//                return new int[][]{{4, 5}, {10, 18}};
//            case 4:
//                return new int[][]{{1, 8}, {3, 5}};
//            case 5:
//                return new int[][]{{3, 4}, {13, 20}};
//            case 6:
//                return new int[][]{{7, 8}, {11, 15}};
//            case 7:
//                return new int[][]{{6, 8}, {1, 4}};
//            case 8:
//                return new int[][]{{6, 7}, {12, 17}};
//            case 9:
//                return new int[][]{{0, 21}, {10, 11}};
//            case 10:
//                return new int[][]{{9, 11}, {3, 18}};
//            case 11:
//                return new int[][]{{9, 10}, {6, 15}};
//            case 12:
//                return new int[][]{{8, 17}, {13, 14}};
//            case 13:
//                return new int[][]{{5, 20}, {12, 14}};
//            case 14:
//                return new int[][]{{2, 23}, {12, 13}};
//            case 15:
//                return new int[][]{{6, 11}, {16, 17}};
//            case 16:
//                return new int[][]{{15, 17}, {19, 22}};
//            case 17:
//                return new int[][]{{8, 12}, {15, 16}};
//            case 18:
//                return new int[][]{{3, 10}, {19, 20}};
//            case 19:
//                return new int[][]{{16, 22}, {18, 20}};
//            case 20:
//                return new int[][]{{5, 13}, {18, 19}};
//            case 21:
//                return new int[][]{{0, 9}, {22, 23}};
//            case 22:
//                return new int[][]{{16, 19}, {21, 23}};
//            case 23:
//                return new int[][]{{2, 14}, {21, 22}};
//            default:
//                return null;
//        }
//    }
